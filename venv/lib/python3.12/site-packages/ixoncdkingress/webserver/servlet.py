...
class Servlet:
    ...
    def do_post(self, request: Request, response: Response) -> None:
        ...
        if not self.config.production_mode:
            ...
            logger.info("context values: %s", context_values)
        ...
        context, function_location, function_arguments, created_on = self._parse_body(
            request.request_body, request.content_type, context_values
        )
        ...
        out_put = call_function(
            self.config, context, function_location, function_arguments, response
        )
    ...
    def _verify_request(self, request: Request, response: Response, created_on: str | None) -> None:
